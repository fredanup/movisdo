<div id="layoutSidenav_content">
    <main>
        <div class="card-body m-4">
            ...
            <form method="post" action="<?php echo base_url(); ?>/update_alternativa">
                <input type="hidden" name="id" value="<?php echo $alternativa['id']; ?>"><!--Row pregunta-->      
                <input type="hidden" name="id_pregunta" value="<?php echo $alternativa['id_pregunta']; ?>">          
                <?= csrf_field() ?>
                    <div class="form-floating mb-3">
                        <input class="form-control" id="alternativa" type="text" placeholder="Alternativa" name="alternativa" required value="<?php echo $alternativa['alternativa']; ?>"/>
